...
(function () {
    ...
    //@{
    {
        ...
        parsed_idls.forEach(function (parsed_idl) {
            ...
            switch (parsed_idl.type) {
                case "interface":
                    this.members[parsed_idl.name] = new IdlInterface(parsed_idl, /* is_callback = */false, /* is_mixin = */false);
                    break;

                case "interface mixin":
                    this.members[parsed_idl.name] = new IdlInterface(parsed_idl, /* is_callback = */false, /* is_mixin = */true);
                    break;
                ...
                case "callback interface":
                    this.members[parsed_idl.name] = new IdlInterface(parsed_idl, /* is_callback = */true, /* is_mixin = */false);
                    break;
    ...
    function exposed_in(globals) {
        ...
        if ('DedicatedWorkerGlobalScope' in self && self instanceof DedicatedWorkerGlobalScope) {
            return globals.indexOf("Worker") >= 0 || globals.indexOf("DedicatedWorker") >= 0;
        }
        if ('SharedWorkerGlobalScope' in self && self instanceof SharedWorkerGlobalScope) {
            return globals.indexOf("Worker") >= 0 || globals.indexOf("SharedWorker") >= 0;
        }
        if ('ServiceWorkerGlobalScope' in self && self instanceof ServiceWorkerGlobalScope) {
            return globals.indexOf("Worker") >= 0 || globals.indexOf("ServiceWorker") >= 0;
        }
    ...
    //@{
    {
        ...
        this.partials.forEach(function (parsed_idl) {
            if (!(parsed_idl.name in this.members) || !(this.members[parsed_idl.name] instanceof IdlInterface)) {
    ...
    //@{
    {
        if (type.idlType in this.members && this.members[type.idlType] instanceof IdlTypedef) {
        ...
        switch (type) {
            ...
            case "boolean":
                assert_equals(typeof value === "undefined" ? "undefined" : _typeof(value), "boolean");
                return;

            case "byte":
                assert_equals(typeof value === "undefined" ? "undefined" : _typeof(value), "number");
            ...
            case "DOMString":
                assert_equals(typeof value === "undefined" ? "undefined" : _typeof(value), "string");
                return;
            ...
            case "object":
                assert_in_array(typeof value === "undefined" ? "undefined" : _typeof(value), ["object", "function"], "wrong type: not object or function");
                return;
        }
        ...
        if (this.members[type] instanceof IdlInterface) {
            ...
            assert_in_array(typeof value === "undefined" ? "undefined" : _typeof(value), ["object", "function"], "wrong type: not object or function");
            if (value instanceof Object && !this.members[type].has_extended_attribute("NoInterfaceObject") && type in self) {
    ...
    //@{
    {
        ...
        if (this.has_extended_attribute("Unforgeable")) {
            this.members.filter(function (m) {
                return !m["static"] && (m.type == "attribute" || m.type == "operation");
            }).forEach(function (m) {
    ...
    //@{
    {
        test(function () {
            ...
            if (this.is_callback()) {
                ...
                assert_equals(Object.getPrototypeOf(self[this.name]), Function.prototype, "prototype of self's property " + format_value(this.name) + " is not Object.prototype");
            ...
            if (this.base) {
                ...
                //    interface."
                var has_interface_object = !this.array.members[this.base].has_extended_attribute("NoInterfaceObject");
        ...
        test(function () {
            ...
            if (this.is_callback()) {
                assert_false("prototype" in self[this.name], this.name + ' should not have a "prototype" property');
                return;
            }
            ...
            if (this.name === "Window") {
                ...
                if (this.base) {
                    ...
                    inherit_interface_has_interface_object = !this.array.members[inherit_interface].has_extended_attribute("NoInterfaceObject");
                ...
                if (inherit_interface_has_interface_object) {
                    ...
                    assert_equals(Object.getPrototypeOf(self[this.name].prototype), self[inherit_interface].prototype, 'prototype of ' + this.name + '.prototype is not ' + inherit_interface + '.prototype');
                } else {
                    ...
                    assert_class_string(Object.getPrototypeOf(self[this.name].prototype), inherit_interface + 'Prototype', 'Class name for prototype of ' + this.name + '.prototype is not "' + inherit_interface + 'Prototype"');
                }
            }
        ...
        test(function () {
            ...
            assert_own_property(self[this.name].prototype, "constructor", this.name + '.prototype does not have own property "constructor"');
    ...
    //@{
    {
        ...
        test(function (t) {
            ...
            assert_equals(Object.getPrototypeOf(obj), originalValue, "original value not modified");
        }.bind(this), this.name + " interface: internal [[SetPrototypeOf]] method " + "of " + type + " - setting to a new value via Object.setPrototypeOf " + "should throw a TypeError");
        ...
        test(function (t) {
            ...
            assert_throws(new TypeError(), function () {
                _defaults(obj, newValue);
            });

            assert_equals(Object.getPrototypeOf(obj), originalValue, "original value not modified");
        }.bind(this), this.name + " interface: internal [[SetPrototypeOf]] method " + "of " + type + " - setting to a new value via __proto__ " + "should throw a TypeError");
        ...
        test(function (t) {
            ...
            assert_equals(Object.getPrototypeOf(obj), originalValue, "original value not modified");
        }.bind(this), this.name + " interface: internal [[SetPrototypeOf]] method " + "of " + type + " - setting to a new value via Reflect.setPrototypeOf " + "should return false");

        test(function () {
            var originalValue = Object.getPrototypeOf(obj);

            Object.setPrototypeOf(obj, originalValue);
        }.bind(this), this.name + " interface: internal [[SetPrototypeOf]] method " + "of " + type + " - setting to its original value via Object.setPrototypeOf " + "should not throw");

        test(function () {
            var originalValue = Object.getPrototypeOf(obj);

            _defaults(obj, originalValue);
        }.bind(this), this.name + " interface: internal [[SetPrototypeOf]] method " + "of " + type + " - setting to its original value via __proto__ " + "should not throw");

        test(function () {
            var originalValue = Object.getPrototypeOf(obj);

            assert_true(Reflect.setPrototypeOf(obj, originalValue));
        }.bind(this), this.name + " interface: internal [[SetPrototypeOf]] method " + "of " + type + " - setting to its original value via Reflect.setPrototypeOf " + "should return true");
    };
    ...
    //@{
    {
        ...
        test(function () {
            ...
            // value."
            assert_equals(self[this.name][member.name], constValue(member.value), "property has wrong value");
        ...
        test(function () {
            ...
            assert_equals(self[this.name].prototype[member.name], constValue(member.value), "property has wrong value");
            var desc = Object.getOwnPropertyDescriptor(self[this.name], member.name);
            assert_false("get" in desc, "property should not have a getter");
            assert_false("set" in desc, "property should not have a setter");
            assert_false(desc.writable, "property should not be writable");
    ...
    //@{
    {
        ...
        a_test.step(function () {
            ...
            if (member["static"]) {
                assert_own_property(self[this.name], member.name, "The interface object must have a property " + format_value(member.name));
                a_test.done();
            } else if (this.is_global()) {
                assert_own_property(self, member.name, "The global object must have a property " + format_value(member.name));
                assert_false(member.name in self[this.name].prototype, "The prototype object should not have a property " + format_value(member.name));

                var getter = Object.getOwnPropertyDescriptor(self, member.name).get;
                assert_equals(typeof getter === "undefined" ? "undefined" : _typeof(getter), "function", format_value(member.name) + " must have a getter");
                ...
                assert_true(member.name in self[this.name].prototype, "The prototype object must have a property " + format_value(member.name));
                ...
                if (!member.has_extended_attribute("LenientThis")) {
                    if (member.idlType.generic !== "Promise") {
                        ...
                        promise_rejects(a_test, new TypeError(), self[this.name].prototype[member.name]).then(function () {
    ...
    //@{
    {
        var a_test = async_test(this.name + " interface: operation " + member.name + "(" + member.arguments.map(function (m) {
    ...
    //@{
    {
        ...
        assert_true(desc.enumerable, "property should be enumerable");
        assert_equals(desc.configurable, !operationUnforgeable, "property should be configurable if and only if not unforgeable");
        // "The value of the property is a Function object whose
        // behavior is as follows . . ."
        assert_equals(_typeof(memberHolderObject[member.name]), "function", "property must be a function");
        // "The value of the Function object’s “length” property is
        // a Number determined as follows:
        // ". . .
        // "Return the length of the shortest argument list of the
        // entries in S."
        assert_equals(memberHolderObject[member.name].length, minOverloadLength(this.members.filter(function (m) {
        ...
        if (!member["static"]) {
            var cb;
            if (!this.is_global() && memberHolderObject[member.name] != self[member.name]) {
    ...
    //@{
    {
        this.members.push(new IdlInterfaceMember({ type: "operation", name: "entries", idlType: "iterator", arguments: [] }));
        this.members.push(new IdlInterfaceMember({ type: "operation", name: "keys", idlType: "iterator", arguments: [] }));
        this.members.push(new IdlInterfaceMember({ type: "operation", name: "values", idlType: "iterator", arguments: [] }));
        this.members.push(new IdlInterfaceMember({ type: "operation", name: "forEach", idlType: "void",
            arguments: [{ name: "callback", idlType: { idlType: "function" } }, { name: "thisValue", idlType: { idlType: "any" }, optional: true }] }));
    };
    ...
    //@{
    {
        test(function () {
            ...
            assert_true(desc.enumerable, "property should be enumerable");
            assert_equals(desc.configurable, !stringifierUnforgeable, "property should be configurable if and only if not unforgeable");
            // "The value of the property is a Function object, which behaves as
            // follows . . ."
            assert_equals(_typeof(interfacePrototypeObject.toString), "function", "property must be a function");
        ...
        for (var i = 0; i < this.members.length; i++) {
            ...
            if (!exposed_in(exposure_set(member, this.exposureSet))) {
                test(function () {
                    ...
                    assert_false(member.name in self[this.name], "The interface object must not have a property " + format_value(member.name));
                    assert_false(member.name in self[this.name].prototype, "The prototype object must not have a property " + format_value(member.name));
    ...
    //@{
    {
        ...
        if (!this.has_extended_attribute("NoInterfaceObject") && ((typeof obj === "undefined" ? "undefined" : _typeof(obj)) != expected_typeof || obj instanceof Object)) {
            test(function () {
                assert_equals(exception, null, "Unexpected exception when evaluating object");
                assert_equals(typeof obj === "undefined" ? "undefined" : _typeof(obj), expected_typeof, "wrong typeof object");
                assert_own_property(self, this.name, "self does not have own property " + format_value(this.name));
                assert_own_property(self[this.name], "prototype", 'interface "' + this.name + '" does not have own property "prototype"');
                ...
                // environment."
                assert_equals(Object.getPrototypeOf(obj), self[this.name].prototype, desc + "'s prototype is not " + this.name + ".prototype");
    ...
    //@{
    {
        ...
        for (var i = 0; i < this.members.length; i++) {
            ...
            } else if (member.type == "operation" && member.name && member.isUnforgeable) {
                var a_test = async_test(this.name + " interface: " + desc + ' must have own property "' + member.name + '"');
                a_test.step(function () {
                    assert_equals(exception, null, "Unexpected exception when evaluating object");
                    assert_equals(typeof obj === "undefined" ? "undefined" : _typeof(obj), expected_typeof, "wrong typeof object");
                    assert_own_property(obj, member.name, "Doesn't have the unforgeable operation property");
                    this.do_member_operation_asserts(obj, member, a_test);
                }.bind(this));
            } else if ((member.type == "const" || member.type == "attribute" || member.type == "operation") && member.name) {
                var described_name = member.name;
                if (member.type == "operation") {
                    described_name += "(" + member.arguments.map(function (arg) {
                        return arg.idlType.idlType;
                    }).join(", ") + ")";
                }
                test(function () {
                    assert_equals(exception, null, "Unexpected exception when evaluating object");
                    ...
                    if (!member["static"]) {
                        ...
                        if (member.type == "operation") {
                            assert_equals(_typeof(obj[member.name]), "function");
                        }
                    }
            ...
            if (member.type == "operation" && member.name && member.arguments.length) {
                var a_test = async_test(this.name + " interface: calling " + member.name + "(" + member.arguments.map(function (m) {
                    return m.idlType.idlType;
                }).join(", ") + ") on " + desc + " with too few arguments must throw TypeError");
                a_test.step(function () {
                    assert_equals(exception, null, "Unexpected exception when evaluating object");
                    assert_equals(typeof obj === "undefined" ? "undefined" : _typeof(obj), expected_typeof, "wrong typeof object");
                    var fn;
    ...
    //@{
    {
        ...
        // is as follows:"
        assert_equals(_typeof(desc.get), "function", "getter must be Function");
        ...
        if (!member["static"]) {
            ...
            if (!member.has_extended_attribute("LenientThis")) {
                if (member.idlType.generic !== "Promise") {
                    ...
                    pendingPromises.push(promise_rejects(a_test, new TypeError(), desc.get.call({}), "calling getter on wrong object type must reject the return promise with TypeError"));
                }
            } else {
        ...
        if (member.readonly && !member.has_extended_attribute("LenientSetter") && !member.has_extended_attribute("PutForwards") && !member.has_extended_attribute("Replaceable")) {
            ...
            assert_equals(_typeof(desc.set), "function", "setter must be function for PutForwards, Replaceable, or non-readonly attributes");
