...
√ RTCIceTransport [0/2]
× RTCPeerConnection-addIceCandidate (Fail: No se pudo completar la operación debido un error 80020101.) [17/23]
√ RTCPeerConnection-addTrack.https [0/8]
√ RTCPeerConnection-addTransceiver [4/15]
× RTCPeerConnection-canTrickleIceCandidates (Fail: No se pudo completar la operación debido un error 80020101.) [1/3]
...
√ RTCPeerConnection-createOffer [2/8]
...
× RTCPeerConnection-ontrack.https (Fail: No se pudo completar la operación debido un error 80020101.) [1/5]
√ RTCPeerConnection-peerIdentity [0/6]
√ RTCPeerConnection-removeTrack.https [0/12]
√ RTCPeerConnection-setDescription-transceiver [0/5]
√ RTCPeerConnection-setLocalDescription-answer [2/6]
√ RTCPeerConnection-setLocalDescription-offer [4/7]
√ RTCPeerConnection-setLocalDescription-pranswer [2/7]
× RTCPeerConnection-setLocalDescription-rollback (Timeout) [0/5]
√ RTCPeerConnection-setLocalDescription [3/4]
√ RTCPeerConnection-setRemoteDescription-answer [2/4]
√ RTCPeerConnection-setRemoteDescription-offer [0/8]
√ RTCPeerConnection-setRemoteDescription-pranswer [6/7]
√ RTCPeerConnection-setRemoteDescription-replaceTrack.https [0/6]
× RTCPeerConnection-setRemoteDescription-rollback (Timeout) [0/4]
√ RTCPeerConnection-setRemoteDescription-tracks.https [0/12]
× RTCPeerConnection-setRemoteDescription (Timeout) [0/6]
...
√ RTCRtpReceiver-getContributingSources.https [0/1]
√ RTCRtpReceiver-getParameters [0/1]
√ RTCRtpReceiver-getStats [0/1]
√ RTCRtpReceiver-getSynchronizationSources.https [0/1]
