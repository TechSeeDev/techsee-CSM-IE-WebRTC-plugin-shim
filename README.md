...
```
× datachannel-emptystring [Timeout]
× getstats [Timeout]
√ historical [12/14]
...
× RTCPeerConnection-connectionState [Timeout]
√ RTCPeerConnection-constructor [18/22]
√ RTCPeerConnection-createAnswer [0/3]
√ RTCPeerConnection-createDataChannel [2/30]
...
× RTCPeerConnection-ondatachannel [Timeout]
√ RTCPeerConnection-onnegotiationneeded [3/7]
...
× RTCPeerConnection-setLocalDescription-rollback [Timeout]
...
× RTCPeerConnection-setRemoteDescription-rollback [Timeout]
√ RTCPeerConnection-setRemoteDescription-tracks.https [2/12]
× RTCPeerConnection-setRemoteDescription [Timeout]
...
× RTCRtpReceiver-getContributingSources.https [FailNo se pudo completar la operación debido un error 80020101.]
√ RTCRtpReceiver-getParameters [0/1]
√ RTCRtpReceiver-getStats [0/1]
× RTCRtpReceiver-getSynchronizationSources.https [FailNo se pudo completar la operación debido un error 80020101.]
